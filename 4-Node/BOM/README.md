...
The file **./BOM/4_NODE_BOM_electronics.csv** provides a complete bill of materials for the electronic components. Please note that this is a sample list based on the configuration I built. Components that can be customized by the user are marked accordingly.
